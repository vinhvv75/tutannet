...
$spider_random_post_id=0;
	...
	class best_magazine_spider_random_post extends WP_Widget {

	// Constructor //

		function best_magazine_spider_random_post() {
			$widget_ops = array( 'classname' => 'best_magazine_spider_random_post', 'description' => __('Spider Random Post allows you to show posts in a random order in a sidebar.','best-magazine') ); // Widget Settings
			$control_ops = array( 'id_base' => 'best_magazine_spider_random_post' ); // Widget Control Settings
			$this->WP_Widget( 'best_magazine_spider_random_post', __('Spider Random Post','best-magazine'), $widget_ops, $control_ops ); // Create the widget
		}
...
// End class best_magazine_spider_random_post

add_action('widgets_init', create_function('', 'return register_widget("best_magazine_spider_random_post");'));
