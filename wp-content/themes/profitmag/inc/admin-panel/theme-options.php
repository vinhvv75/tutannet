     ...
     <div class="wrap" id="optionsframework-wrap">
        ...
        <div class="profitmag-header">
            ...
            <div class="profitmag-title">
                ...
                <input type="hidden" name="business" value="Payments@keysthemes.com">
                    ...
                    <form id="form-options" method="post" action="options.php">
            			...
            			<div id="options-group-8" class="group" style="display: none;">
                			<h3><?php _e('Know more about ProfitMag Themes','profitmag'); ?></h3>
                				<div class="form-row">
                		      		<p><?php echo sprintf(__('ProfitMag Theme developed by <a href="%s" target="_blank">Keysthemes</a>', 'profitmag' ),esc_url('http://www.keysthemes.com/')); ?></p>
                				</div>		
                                <div class="form-row">
                                    <p><?php _e('For Live Preview of the Theme','profitmag'); ?></p>
                                    <p><a target="_blank" class="button" href="<?php echo esc_url('http://keysthemes.com/theme-demo/?theme=profitmag-pro/'); ?>"><?php _e('Live Demo','profitmag'); ?></a></p>
                                </div>	
                                <div class="form-row">
                                    <p><?php _e('For Support / Premium Customization','profitmag'); ?></p>
                                    <p><a target="_blank" href="mailto:payments@keysthemes.com">payments@keysthemes.com</a></p>
                                </div>
