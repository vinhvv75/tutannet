...
function vye_menu_initialise() {
	...
	add_menu_page( __( 'About YouTube Embed', 'youtube-embed' ), __( 'YouTube', 'youtube-embed' ), $menu_access, 'general-options', 'vye_general_options', $menu_icon );
...
function vye_general_options() {
	...
	include_once( get_template_directory() . '/inc/youtube-embed/includes/options-general.php' );
...
function vye_profile_options() {
	...
	include_once( get_template_directory() . '/inc/youtube-embed/includes/options-profiles.php' );
...
function vye_list_options() {
	...
	include_once( get_template_directory() . '/inc/youtube-embed/includes/options-lists.php' );
...
register_activation_hook( get_template_directory() . "/inc/youtube-embed/youtube-embed.php", 'vye_plugin_activate' );
