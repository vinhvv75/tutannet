      ...
      var bwg_transition_duration =  best_magazine_slider_options.animation_speed;
...
//////////
      ...
      function bwg_cube(tz, ntx, nty, nrx, nry, wrx, wry, current_image_class, next_image_class, direction) {
        ...
        jQuery("#bwg_dots_" + bwg_current_key + "").removeClass("bwg_slideshow_dots_deactive").addClass("bwg_slideshow_dots_active");
      ...
      function bwg_change_image(current_key, key, data, from_effect) {		
        if (data[key]) {
		  ...
		  jQuery(".bwg_slideshow_description_text").removeAttr("class").addClass("bwg_slideshow_description_text");
		  jQuery(".bwg_slideshow_description_text").addClass("text_id_" + data[key]["id"]);
		  
		  jQuery(".bwg_slideshow_title_text").html(data[key]["title"]);
		  jQuery(".bwg_slideshow_title_text").html(jQuery('<div />').html(data[key]["title"]));
		  jQuery(".bwg_slideshow_title_text").removeAttr("class").addClass("bwg_slideshow_title_text");
		  jQuery(".bwg_slideshow_title_text").addClass("descr_id_" + data[key]["id"]);
		  ...
		  var effect_name = "bwg_" + best_magazine_slider_options.effect;
          window[effect_name](current_image_class, next_image_class, direction);
		  
		  jQuery('.bwg_slideshow_description_text,.bwg_slideshow_title_text').removeClass('none');
		  if(jQuery(".text_id_" + data[key]["id"]).html()=="" || jQuery(".text_id_" + data[key]["id"]).html()=="<div></div>"){jQuery(".text_id_" + data[key]["id"]).addClass('none');}
		  if(jQuery(".descr_id_" + data[key]["id"]).html()=="" || jQuery(".descr_id_" + data[key]["id"]).html()=="<div></div>"){jQuery(".descr_id_" + data[key]["id"]).addClass('none');}
		}
      ...
      function bwg_popup_resize() {
	   ...
	   //standart chap vor@ voroshvac chi bnav template um
		...
		var str=(best_magazine_slider_options.image_height/firstsize  );	
      ...
      function play() {
        ...
        }, ''+best_magazine_slider_options.slideshow_interval+'');
      }
	  ...
	  var pausehover=best_magazine_slider_options.stop_on_hover;
	  if(pausehover==1){
