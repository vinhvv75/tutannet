...
function vye_main_scripts() {
	...
	wp_register_style( 'vye_dynamic', get_template_directory_uri() . '/inc/youtube-embed/css/main.min.css' );
...
function vye_admin_css() {
	...
	wp_enqueue_style( 'tinymce_button', get_template_directory_uri() . '/inc/youtube-embed/css/admin.min.css' );
