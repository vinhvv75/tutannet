	...
	<div id="section-intro">
		<h2 class="section-name"><span>Tin Tức Phật Sự</span></h2>
	      ...
	      <?php 
	      	  ...
	      	  echo '<div id="news-content" class="section-content col-md-12 clo-lg-12">';
	          ...
	          if($block_news_query->have_posts()){
	          	while($block_news_query->have_posts()){
	          	      ...
	          	      $block_news_query->the_post();
	          	        ...
	          	        if($b_counter <= 2):
	          	        	echo '<div class="featured-post single-post col-xs-12 col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="0.5s">';
	          	        ?>
	          	        ...
	          	        <?php endif; 
	          	        	if ($b_counter >= 3) {
	          	        		if ($b_counter % 7 == 0 && $post_format != 'gallery') {echo '<div class="single-post col-xs-12 col-sm-6 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="1s>';}
	          	        			...
	          	        			if ($b_counter % 2 == 0) {
	          	        				echo '<div class="single-post col-xs-12 col-sm-6 col-md-3 col-lg-3 hidden-md hidden-lg wow fadeInUp" data-wow-delay="0.5s">';
	          	        					echo '<div class="post-desc-wrapper">';
	          	        						tutannet_askmembership_post();
	          	        					echo '</div>';		   
	          	        				echo '</div>';
	          	        			}		          	          	        			
	          	        			echo '<div class="single-post gallery-post col-xs-12 col-sm-12 col-md-9 col-lg-9 wow fadeInUp" data-wow-delay="0.5s">';
	          	        		} 
	          	        		else {echo '<div class="single-post col-xs-12 col-sm-6 col-md-3 col-lg-3 wow fadeInUp" data-wow-delay="0.5s">';} 
	          	        	}
	          	        ?>
          	        	...
          	        	<?php if ($b_counter == 1) {echo '</div>';}
          	        		  ...
          	        		  if ($post_format == 'gallery' && $has_gallery == true) {
	          	        		  if ($b_counter >=3 && $b_counter % 2 != 0) {
	          	        		  			echo '<div class="single-post col-xs-12 col-sm-6 col-md-3 col-lg-3 wow fadeInUp" data-wow-delay="0.5s">';
	          	        		  				echo '<div class="post-desc-wrapper">
          	        		  ...
          	        		  if ($b_counter > 3 && $b_counter == $total_posts_block_news) {echo '</div>';} // news content          	        		  
          	        	?>
